### 7. Напишите программу, которая выдаёт запрос на ввод значений часов и минут. Функция ```main()``` должна передать эти два значения функции, имеющей тип ```void```, которая отобразит эти два значения в следующем виде:
