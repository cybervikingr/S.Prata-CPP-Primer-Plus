...
int main()
{
    using namespace std;
    const int Size(15);
    char name1[Size];               // empty array //пустой массив
    char name2[Size] = "C++owboy";  // initialize array // инициализация массива
    ...
    name2[3] = '\0';                // set to null character // установка нулевого символа
